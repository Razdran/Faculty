...
int main() 
  { 
    ...
    if (socketpair(AF_UNIX, SOCK_STREAM, 0, sockp) < 0) // primul parametru- mediu de comunicare
							// ultimul parametru - unde vor fi plasati 
							// descriptori socketului
      { 
...
//codul nu contine wait!!!!
// ORICAND AVEM FORC INTR-UN COD AR TREBUI SA AVEM WAIT!!!
